...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username') displayInfo=(realm.password && realm.registrationAllowed && !registrationDisabled??); section>
    ...
    <#elseif section = "socialProviders">
        <#-- we render the buttons for social providers in the form section (see below) so that they show up above the "try another way" button -->
    <#elseif section = "form">
                ...
                <ul class="${properties.kcFormSocialAccountListClass!} <#if hidpd.providers?size gt 3>${properties.kcFormSocialAccountListGridClass!}</#if>">
                    <#list hidpd.providers as p>
                        <li class="${properties.kcFormSocialAccountListItemClass!}">
                            <a id="social-${p.alias}" class="${properties.kcFormSocialAccountListButtonClass!} <#if hidpd.providers?size gt 3>${properties.kcFormSocialAccountGridItem!}</#if>" aria-label="${p.displayName}"
